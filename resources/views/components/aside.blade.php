       ...
       <aside class="sidebar-wrapper" data-simplebar="true">
           <div class="sidebar-header">
               <div>
                   <img src="https://bill.onepay.my.id/assets/images/favicon.png" class="logo-icon" alt="logo icon">
               </div>
               <div>
                   <h4 class="logo-text">@Naufal.ID</h4>
               </div>
           ...
           <ul class="metismenu" id="menu">
               ...
               <li class="{{ request()->is('phonebook') ? 'active' : '' }}">
                   <a href="{{ route('phonebook') }}">
                       ...
                       <div class="menu-title">Buku Telepon</div>
                   </a>
               </li>
               {{-- reports --}}
               <li>
                   <a href="javascript:;" class="has-arrow">
                       ...
                       <div class="menu-title">Laporan Pesan</div>
                   </a>
                   <ul>
                       <li class="{{ request()->is('campaigns') ? 'active' : '' }}">
                           <a href="{{ route('campaigns') }}"><i class="bi bi-circle"></i>Pesan Terjadwal</a>
                       </li>
               ...
               @if (Session::has('selectedDevice'))
                   <li class="{{ request()->is('autoreply') ? 'active' : '' }}">
                       <a href="{{ route('autoreply') }}">
                           ...
                           <div class="menu-title">Balas Otomatis</div>
                       </a>
                   </li>
                   {{-- Create campaign --}}
                   <li class=" {{ url()->current() == route('campaign.create') ? 'mm-active' : '' }}">
                       <a class="" href="{{ route('campaign.create') }}">
                           ...
                           <div class="menu-title">Pesan Terjadwal</div>
                       </a>
                   </li>
                   {{-- end create campaign --}}
                   {{-- Message Test --}}
                   <li class=" {{ url()->current() == route('messagetest') ? 'mm-active' : '' }}">
                       <a class="" href="{{ route('messagetest') }}">
                           ...
                           <div class="menu-title">Kirimkan Pesan</div>
                       </a>
                   </li>
                   {{-- Message Test --}}
               @endif
               ...
               @if (Auth::user()->level == 'admin')
                   <li>
                       <a href="javascript:;" class="has-arrow">
                           ...
                           <div class="menu-title">Fitur Admin</div>
                       </a>
                       <ul>
                           ...
                           <li class="{{ request()->is('admin.manage-users') ? 'active' : '' }}">
                               <a href="{{ route('admin.manage-users') }}"><i class="bi bi-circle"></i> Daftar Pengguna</a>
                           </li>
